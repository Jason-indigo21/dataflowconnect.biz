            ...
            <div class="container ">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-left mt-3" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="">
                            <a href="?page=solutions-by-sector<?php echo($_REQUEST['lang']=='es') ?'&lang=es' :'&lang=en'?>" class="<?php echo $_REQUEST['page'] == 'solutions-by-sector' ? "active" : ""; ?>" class="<?php echo $_REQUEST['page'] == 'solutions-by-sector' ? "active" : ""; ?> "><?php echo !isset($_REQUEST['lang'])  || $_REQUEST['lang'] != 'en' ? 'SOLUCIONES POR SECTOR' : 'SOLUTIONS BY SECTOR' ?></a>
                        </li>
                        <li class="">
                            <a href="?page=digital-infrastructure<?php echo($_REQUEST['lang']=='es') ?'&lang=es' :'&lang=en'?>" class="<?php echo $_REQUEST['page'] == 'digital-infrastructure' ? "active" : ""; ?>" class="<?php echo $_REQUEST['page'] == 'digital-infrastructure' ? "active" : ""; ?> "><?php echo !isset($_REQUEST['lang'])  || $_REQUEST['lang'] != 'en' ? 'INFRAESTRUCTURA DIGITAL' : 'DIGITAL INFRASTRUCTURE' ?></a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-left mt-3" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="">
                            <a href="?page=discover-more<?php echo($_REQUEST['lang']=='es') ?'&lang=es' :'&lang=en'?>" class="<?php echo $_REQUEST['page'] == 'discover-more' ? "active" : ""; ?>" class="<?php echo $_REQUEST['page'] == 'discover-more' ? "active" : ""; ?> "><?php echo !isset($_REQUEST['lang'])  || $_REQUEST['lang'] != 'en' ? 'DESCUBRA MAS' : 'DISCOVER MORE' ?></a>
                        </li>
                        <li class="">
                            <a href="?page=frequesntly-asked-question<?php echo($_REQUEST['lang']=='es') ?'&lang=es' :'&lang=en'?>" class="<?php echo $_REQUEST['page'] == 'frequesntly-asked-question' ? "active" : ""; ?>" class="<?php echo $_REQUEST['page'] == 'frequesntly-asked-question' ? "active" : ""; ?> "><?php echo !isset($_REQUEST['lang'])  || $_REQUEST['lang'] != 'en' ? 'PREGUNTAS FRECUENTES' : 'FREQUENTLY ASKED QUESTIONS' ?></a>
                        </li>
                        <li>
                            <a href="?page=contact-us<?php echo($_REQUEST['lang']=='es') ?'&lang=es' :'&lang=en'?>" class="<?php echo $_REQUEST['page'] == 'contact-us' ? "active" : ""; ?>" class="<?php echo $_REQUEST['page'] == 'contact-us' ? "active" : ""; ?> "><?php echo !isset($_REQUEST['lang'])  || $_REQUEST['lang'] != 'en' ? 'CONTACTENOS' : 'CONTACT US' ?></a>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="<?php echo !isset($_REQUEST['service']) ? 'active' : '' ?>"><a href="#"><?php echo $nav['title']; ?></a></li>
                                    <?php
