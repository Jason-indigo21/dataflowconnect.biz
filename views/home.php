    <div class="banner-area content-bg circle-shape ">
        <!-- Background -->
        <div class="bg" style="background-image: url(assets/images/home-1.jpg);"></div>
        <!-- End Background -->
        <div class="item">
            <div class="container">
        ...
        <div class="container">
            <div class="row align-center">
                ...
                <div class="col-lg-6 info wow fadeInUp">
                    ...
                    <p>
                        <a href="./?page=contact-us<?php echo ($_REQUEST['lang'] == 'es') ? '&lang=es' : '&lang=en' ?>" class="btn-animate wow fadeInRight">
                            <span class="circle">
                ...
                <div class="col-lg-6">
                    <div class="thumb wow fadeInRight" data-wow-delay="0.6s">
                        <img src="assets/images/home-2.jpg" alt="Thumb">
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php foreach ($services as $service): ?>
                    <div class="single-item col-lg-4 col-md-6">
                            <div class="item">
                                ...
                                <?=$service['icon'] ?>
                                <h4><a href="./?page=our-proposal&service=<?=$service['link'] ?><?php echo ($_REQUEST['lang'] == 'es') ? '&lang=es' : '&lang=en' ?>"><?= $service['title'] ?></a></h4>
                                <p>
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <div class="content">
                            <div class="heading">
                                ...
                                <a href="./?page=contact-us<?php echo ($_REQUEST['lang'] == 'es') ? '&lang=es' : '&lang=en' ?>" class="btn-animate wow fadeInRight my-4 w-100">
                                    <span class="circle">
                                        <span class="icon arrow"></span>
                                    </span>
